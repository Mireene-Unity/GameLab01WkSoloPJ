...
public class GameManager : MonoBehaviour
{
    ...
    private Vector3 _windDiraction;
    private float _windResetTime;
    ...
    {
        StopSpawnCoroutine(SpawnCoroutineList.Shark);// 상어 소환 중지
    ...
    public void BossStart()
    {
        ...
        // 상어 소환 중지
        StopSpawnCoroutine(SpawnCoroutineList.Shark);
    ...
    void StopSpawnCoroutine(SpawnCoroutineList CoroutineObjName)
    {
        int objName = (int)CoroutineObjName; 
        if (spawnIntervalCorouineList.Count >= 2 && spawnIntervalCorouineList[1] != null)
        {
            StopCoroutine(spawnIntervalCorouineList[1]);
            spawnIntervalCorouineList[1] = null;
        }
    }
    public void SetWindDiraction(Vector3 Diraction, float ResetTime)
    {
        _windDiraction = Diraction;
        _windResetTime = ResetTime;
    }
    public Vector3 WindDiraction()
    {
        if (isGameOver) { return new(0, 0, 0); }
        else return _windDiraction; 
    }
    public float WindResetTime()
    {
        return _windResetTime;
    }
}